...
namespace AssetKits.ParticleImage
{
    ...
    public sealed class ParticleImage : MaskableGraphic
    {
        ...
        [SerializeField]
        private UnityEvent<ParticleImage> _onParticleFinish = new UnityEvent<ParticleImage>();
        
        /// <summary>
        /// Called when any piece of a particle finishes.
        /// </summary>
        public UnityEvent<ParticleImage> onAnyParticleFinished => _onParticleFinish;
