...
namespace OPS.Obfuscator.Editor.Project.PostAssemblyBuild.Compatibility.Component
{
    public class UnityCompatibilityComponent : AObfuscationCompatibilityComponent, INamespaceCompatibility, ITypeCompatibility, IMethodCompatibility, IFieldCompatibility
    {
        ...
        {
            // ### Field -> Obfuscate Serializeable Unity Fields ###

            // If the Field has the Unity 'SerializeField' attribute and settings forbidde obfuscation of it. Then skip this field.
            if (OPS.Obfuscator.Editor.Assembly.Unity.Member.Helper.FieldDefinitionHelper.IsFieldSerializeAble(_FieldDefinition))
            {
                // If the Field has the 'SerializeField' attribute and field settings forbidde obfuscation of serializeable fields. Then skip this field.
                if (!Helper_Setting_Obfuscate_Field_Serializable(_Step))
                {
                    // Cause
                    _Cause = "The field has a 'SerializeField' attribute and therefore is serializeable. The disabled setting 'Obfuscate SerializeAble Fields' deactivates obfuscation this field.";
                    return false;
                }

                // If the Field has the 'SerializeField' attribute and class settings forbidde obfuscation of serializeable fields. Then skip this field.
                ...
                {
                    // Cause
                    _Cause = "The field has a 'SerializeField' attribute and is in a serializeable class therefore is serializeable. The disabled setting 'Obfuscate SerializeAble Classes' deactivates obfuscation of this field.";
                    return false;
                }
            }
