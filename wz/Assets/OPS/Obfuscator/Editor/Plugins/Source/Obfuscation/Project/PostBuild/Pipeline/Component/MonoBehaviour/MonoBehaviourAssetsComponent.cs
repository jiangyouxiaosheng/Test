...
namespace OPS.Obfuscator.Editor.Project.PostBuild.Pipeline.Component
{
    internal class MonoBehaviourAssetsComponent : APostBuildComponent
    {
        ...
        public override bool OnPrePipelineProcess(IStepInput _StepInput)
        {
            ...
            if (_StepInput == null)
            {
                this.MonobehaviourObfuscationMapping = new Dictionary<TypeKey, TypeKey>();
            }
            else
            {
            ...
            if(this.MonobehaviourObfuscationMapping == null || this.MonobehaviourObfuscationMapping.Count == 0)
            {
                ...
                Obfuscator.Report.Append(EReportLevel.Warning, String.Format("No MonoBehaviour obfuscation mapping found."));
            }
        ...
        public override bool OnPostBuild()
        {
            ...
            // If the mapping is empty, return true. The assets do not need to be obfuscated.
            if (this.MonobehaviourObfuscationMapping == null || this.MonobehaviourObfuscationMapping.Count == 0)
            {
                return true;
            }
            ...
            if (this.AssetsAreBundled)
            {
                ...
                if (!this.TryOverrideDataUnity3d(this.GetDataUnity3dPath()))
                {
                    ...
                    Obfuscator.Report.Append(EReportLevel.Warning, "Could not obfuscate the data.unity3d file at expected path: " + this.GetDataUnity3dPath(), true);
                }
            }
            else
            {
                ...
                if (!this.TryOverrideGlobalGameManagersAssets(this.GetGlobalGameManagersAssetsPath()))
                {
                    ...
                    Obfuscator.Report.Append(EReportLevel.Warning, "Could not obfuscate the globalgamemanagers.assets file at expected path: " + this.GetGlobalGameManagersAssetsPath(), true);
                }
            }
